...
<div id="content" class="site-content">  	
    ...
    <div id="primary" class="content-area <?php greed_layout_class(); ?>  columns">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php do_action('greed_after_single_content'); ?>
			<?php if( get_theme_mod ('social_sharing_box')): ?>
				<div class="share-box">
					<h4><?php _e( 'Share this on ...', 'greed' ); ?></h4>
					<ul>
				...
				<section class="author-bio clearfix">
					<div class="author-info">
						...
						<div class="description">
							<h4><?php echo __( 'About Author:', 'greed' ); ?> <?php the_author_posts_link(); ?></h4>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'greed_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php greed_related_posts(); ?>
				</section>
			<?php endif;  ?>
