 ...
 * @since 0.1
 */
if( !function_exists('greed_icon_add_icon_picker_control') ) :
	function greed_icon_add_icon_picker_control( $wp_customize ) {
		class Greed_Icon_Customizer_Icon_Picker_Control extends WP_Customize_Control {
			...
			?>
				<label data-title="<?php esc_attr_e('Inline picker','greed'); ?>">
...
add_action( 'customize_register', 'greed_icon_add_icon_picker_control' );
